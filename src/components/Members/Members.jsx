...
import "./Members.css";
import member1 from "../../members/Hridhwesh Maity.jpg";
...
import member10 from "../../members/Sk Mahammad Afzal.jpeg";
...
const Members = () => {
  const membersArr = useMemo(
    () => [
      { id: 1, name: "Hridhwesh Maity", image: member1, whatsappLink: "https://wa.me/+917688085816" },
      ...
      { id: 6, name: "Dipti Bhowmik", image: member6, whatsappLink: "https://wa.me/+919064148052" },
      ...
      { id: 10, name: "Sk Mahammad Afzal", image: member10, whatsappLink: "https://wa.me/+919679186577" },
